"""
Django settings for LeadManagementsys project.
...
SECRET_KEY = 'django-insecure-_wocxd_qk_a^hc(dclio*&x^h9ix!8zwotkxctg@=19h)xk9w!'
...
ROOT_URLCONF = 'LeadManagementsys.urls'
...
WSGI_APPLICATION = 'LeadManagementsys.wsgi.application'
